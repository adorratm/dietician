          ...
          <div class='loginbox'>
            ...
            <div class='login-right'>
              <div class='login-right-wrap'>
                <h1 style='font-size: 21px' v-if='!isEmpty(settings)'>{{settings.settings.company_name}} - Diyetisyen Paneli</h1>
                <p class='account-subtitle'>Diyetisyen Panelinize Erişmeniz Bir Tık Uzağınızda!</p>
