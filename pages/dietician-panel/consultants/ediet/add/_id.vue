                ...
                <v-stepper-content step='4'>
                  <v-simple-table>
                    ...
                    <tr>
                      ...
                      <td>{{ !isEmpty(adultCalorieCalc) && !isEmpty(adultCalorieCalc.original.data.oga) ? (adultCalorieCalc.original.data.oga).toFixed(2) : null }}
                        KG
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        {{ !isEmpty(adultCalorieCalc) && !isEmpty(adultCalorieCalc.original.data.bki) ? (adultCalorieCalc.original.data.bki).toFixed(2) : null }}
                      </td>
                    </tr>
                    <tr>
