  ...
  methods:{
    ...
    retrieveData(url) {
      try {
        ...
        this.$axios
          .get(`${process.env.apiBaseUrl}panel/recipes/${urlParam}?table=recipes&page=${params.page}&per_page=${params.size}&search=${params.title}&search_columns=name`)
          .then(response => {
