          ...
          <v-card-text>
            ...
            >
              <template v-slot:[`item.img_url`]="{ item }">
                <img :src="item.img_url" width="150" height="150" :alt='item.img_url' class='text-center justify-center mx-auto px-auto' />
              </template>
...
export default {
  ...
  methods:{
    ...
    editData(id) {
      try {
        this.$router.push("/panel/nutrients/update/" + id);
      }catch (e) {
        console.log(e)
      }
    },
