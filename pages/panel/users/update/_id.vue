      ...
      <div class="content container-fluid mb-5">
        ...
        <v-stepper v-model='e1'>
          ...
          <v-stepper-items>
            ...
            <v-stepper-content class='p-2' step='2'>
              <ValidationObserver v-slot='{ handleSubmit }'>
                <form
                ...
                >
                  ...
                  <div class='d-flex w-100 flex-wrap'>
                    <v-btn color='primary' type='submit' class='mb-2 mr-3'>
                      Güncelle
                    </v-btn>
                    <v-btn color='error' type='button' class='mb-2 mr-3' @click.prevent='e1=3'>
                      İlerle
                    </v-btn>
            ...
            <v-stepper-content class='p-2' step='3'>
              <ValidationObserver v-slot='{ handleSubmit }'>
                <form
                ...
                >
                  ...
                  <div class='d-flex w-100 flex-wrap'>
                    ...
                    <v-btn color='error' type='button' class='mb-2 mr-3' @click.prevent='e1=4'>
                      İlerle
                    </v-btn>
            ...
            <v-stepper-content class='p-2' step='4'>
              <ValidationObserver v-slot='{ handleSubmit }'>
                <form
                ...
                >
                  ...
                  <div class='d-flex w-100 flex-wrap'>
                    ...
                    <v-btn color='error' type='button' class='mb-2 mr-3' @click.prevent='windowReDraw()'>
                      İlerle
                    </v-btn>
                    <v-btn color='info' type='button' class='mb-2 mr-3' @click.prevent='e1 = 3'>
                      Geri Dön
                    </v-btn>
                  </div>
                </form>
            ...
            <v-stepper-content class='p-2' step="5">
              <ValidationObserver v-slot='{ handleSubmit }'>
                <form
                ...
                >
                  ...
                  <div class='d-flex w-100 flex-wrap'>
                    ...
                    <v-btn color='error' type='button' class='mb-2 mr-3' @click.prevent='e1=6'>
                      İlerle
                    </v-btn>
                    <v-btn color='info' type='button' class='mb-2 mr-3' @click.prevent='e1 = 4'>
                      Geri Dön
                    </v-btn>
                  </div>
                </form>
...
export default {
  ...
  data() {
    return {
      ...
      breadCrumbItems: [
        ...
        {name: 'Kullanıcılar', url: '/panel/consultants'},
  ...
  methods: {
    getWeightAims(onlyData =false){
      try {
        this.$axios
          .get(`${process.env.apiBaseUrl}panel/users/${this.data._id.$oid}/weightaims/get-all`)
          .then(response => {
    ...
    getWeights(onlyData = false){
      try {
        this.$axios
          .get(`${process.env.apiBaseUrl}panel/users/${this.data._id.$oid}/weights/get-all`)
          .then(response => {
    ...
    getDiseases() {
      try {
        this.$axios
          .get(`${process.env.apiBaseUrl}panel/users/user-diseases-get`)
          .then(response => {
    ...
    updateInformation() {
      try {
        ...
        this.$axios
          .post(process.env.apiBaseUrl + 'panel/users/update/' + this.data._id.$oid, formData, {
            headers: {
              'Content-Type':
    ...
    saveAllergenFoodsInformation() {
      try {
        ...
        this.$axios
          .post(
            process.env.apiBaseUrl +
            'panel/users/user-allergenfoods/',
            formData,
            {
              headers: {
                'Content-Type':
