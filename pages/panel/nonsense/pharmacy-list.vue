											...
											<tbody>
													...
													<td>
														<h2 class="table-avatar">
															<a class="avatar avatar-sm mr-2" data-toggle="modal" href="#edit_specialities_details">
																<img class="avatar-img rounded-circle" src='../../../assets/admin_img/features/feature-01.jpg' alt="product image">
															</a>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<a class="avatar avatar-sm mr-2" data-toggle="modal" href="#edit_specialities_details">
																<img class="avatar-img rounded-circle" src='../../../assets/admin_img/features/feature-02.jpg' alt="product image">
															</a>
...
export default {
    ...
    head: {
    title: 'Doccure - Pharmacy List Page'
  },
    layout: 'admin',
	computed: {
       currentPath() {
