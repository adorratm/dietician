                ...
                <div class="col-sm-12">
                        ...
                        <div class="blog blog-single-post">
                            <div class="blog-image">
                                <a href="javascript:void(0);"><img alt="" src='../../../assets/admin_img/blog/blog-01.jpg' class="img-fluid"></a>
                            </div>
                                    ...
                                    <ul>
                                        <li>
                                            <div class="post-author">
                                                <NuxtLink to="doctor-profile"><img src='../../../assets/admin_img/doctors/doctor-thumb-02.jpg' alt="Post Author"> <span>Dr. Darren Elder</span></NuxtLink>
                                            </div>
                                        </li>
                            ...
                            <div class="about-author">
                                <div class="about-author-img">
                                    <div class="author-img-wrap">
                                        <NuxtLink to="doctor-profile"><img class="img-fluid rounded-circle" alt="" src='../../../assets/admin_img/doctors/doctor-thumb-02.jpg'></NuxtLink>
                                    </div>
                                </div>
                                <div class="author-details">
                                    <NuxtLink to="doctor-profile" class="blog-author-name">Dr. Darren Elder</NuxtLink>
                        ...
                        <div class="card blog-comments clearfix">
                            ...
                            <ul class="comments-list">
                                <li>
                                    <div class="comment">
                                        <div class="comment-author">
                                            <img class="avatar" alt="" src='../../../assets/admin_img/patients/patient4.jpg'>
                                        </div>
                                    ...
                                    <ul class="comments-list reply">
                                        <li>
                                            <div class="comment">
                                                <div class="comment-author">
                                                    <img class="avatar" alt="" src='../../../assets/admin_img/patients/patient5.jpg'>
                                                </div>
                                                <div class="comment-block">
                                                    <span class="comment-by">
                                        ...
                                        <li>
                                            <div class="comment">
                                                <div class="comment-author">
                                                    <img class="avatar" alt="" src='../../../assets/admin_img/patients/patient3.jpg'>
                                                </div>
                                                <div class="comment-block">
                                                    <span class="comment-by">
                                ...
                                <li>
                                    <div class="comment">
                                        <div class="comment-author">
                                            <img class="avatar" alt="" src='../../../assets/admin_img/patients/patient6.jpg'>
                                        </div>
                                        <div class="comment-block">
                                            <span class="comment-by">
                                ...
                                <li>
                                    <div class="comment">
                                        <div class="comment-author">
                                            <img class="avatar" alt="" src='../../../assets/admin_img/patients/patient7.jpg'>
                                        </div>
                                        <div class="comment-block">
                                            <span class="comment-by">
