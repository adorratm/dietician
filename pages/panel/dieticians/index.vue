  ...
  methods:{
    ...
    retrieveData(url) {
      try {
        ...
        this.$axios
          .get(`${process.env.apiBaseUrl}panel/datatables/${urlParam}?table=dieticians&page=${params.page}&per_page=${params.size}&search=${params.title}&search_columns=name,email,phone`)
          .then(response => {
