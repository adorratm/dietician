  ...
  <ValidationObserver v-slot='{ handleSubmit }'>
    ...
    >
          ...
          <div class='text-right'>
            <NuxtLink class='forgot-link' rel='dofollow' title='Şifremi Unuttum' to='/forgot-password'>Şifrenizi Unuttunuz Mu?</NuxtLink>
          </div>
          ...
          <div class='text-center dont-have'>Hesabınız Yok Mu?
            <NuxtLink to='/register' rel='dofollow' title='Kayıt Ol'>Kayıt Olun.</NuxtLink>
          </div>
    </form>
  </ValidationObserver>
  <!-- /Login Form -->
